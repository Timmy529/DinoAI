...
# Initializations
prev_low_median = prev_high_median = prev_restart_mean = prev_dino_median = None
...
while True:
    ...
    current_restart_mean = area_mean(restart_area)
    ...
    if (
            ...
            current_restart_mean != prev_restart_mean or
